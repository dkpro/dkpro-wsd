...
/**
 * A resource wrapping algorithms of type {@link WSDAlgorithmIndividualBasic}
 *
 * @author <a href="mailto:miller@ukp.informatik.tu-darmstadt.de">Tristan Miller</a>
 *
 */
public class WSDResourceIndividualBasic
    ...
    implements WSDAlgorithmIndividualBasic
{
    ...
    {
        return ((WSDAlgorithmIndividualBasic) wsdAlgorithm)
                .getDisambiguation(sod);
    }
}
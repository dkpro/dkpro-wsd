...
import de.tudarmstadt.ukp.dkpro.wsd.algorithms.WSDAlgorithmDocumentDependentBasic;
...
extends WSDAnnotatorBaseDocumentDependent
{
	...
	{
		return wsdMethod.getDisambiguation(DocumentMetaData.get(aJCas).getDocumentId(), sod);
	}
